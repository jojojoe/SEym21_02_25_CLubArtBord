...
extension APLoginVC {
    func setupView() {
        ...
        closebutton.alpha = 1
        closebutton.setImage(UIImage(named: "login_ic_close"), for: .normal)
        ...
        //
        let userInfoImgV = UIImageView(image: UIImage(named: "login_background-1"))
        view.addSubview(userInfoImgV)
        userInfoImgV.contentMode = .scaleAspectFit
        userInfoImgV.snp.makeConstraints {
            $0.centerX.equalToSuperview()
            $0.width.equalToSuperview()
            $0.top.equalTo(topTitleLabe.snp.bottom).offset(20)
