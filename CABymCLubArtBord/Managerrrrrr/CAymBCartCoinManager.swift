...
class CAymBCartCoinManager: NSObject {
    var coinCount: Int = 0
    var coinIpaItemList: [StoreItem] = []
    
    static let `default` = CAymBCartCoinManager()
    ...
    func loadDefaultData() {
        ...
        let iapItem0 = StoreItem.init(id: 0, iapId: "com.artins.frameborder.listone", coin: 100, price: "$0.99", color: "#FFDCEC")
        let iapItem1 = StoreItem.init(id: 1, iapId: "com.artins.frameborder.listtwo", coin: 200, price: "$1.99", color: "#C9FFEE")
        let iapItem2 = StoreItem.init(id: 2, iapId: "com.artins.frameborder.listthree", coin: 500, price: "$3.99", color: "#FFDCEC")
        let iapItem3 = StoreItem.init(id: 3, iapId: "com.artins.frameborder.listfour", coin: 800, price: "$5.99", color: "#C9FFEE")
        let iapItem4 = StoreItem.init(id: 4, iapId: "com.artins.frameborder.listfive", coin: 1500, price: "$9.99", color: "#FFDCEC")
        let iapItem5 = StoreItem.init(id: 5, iapId: "com.artins.frameborder.listsix", coin: 2000, price: "$12.99", color: "#C9FFEE")
        let iapItem6 = StoreItem.init(id: 6, iapId: "com.artins.frameborder.listseven", coin: 3000, price: "$16.99", color: "#FFDCEC")
        let iapItem7 = StoreItem.init(id: 7, iapId: "com.artins.frameborder.listeight", coin: 4000, price: "$19.99", color: "#C9FFEE")
...
// Products StoreKit
extension CAymBCartCoinManager: SKProductsRequestDelegate, SKPaymentTransactionObserver {
            ...
            for transaction in transactions {
                ...
                case .purchased:
                    ...
                    if let item = self.currentBuyModel {
                        ...
                        CAymBCartCoinManager.default.addCoin(coin: item.coin)
                        Adjust.trackEvent(ADJEvent(eventToken: AdjustKey.AdjustKeyAppCoinsBuy.rawValue))
